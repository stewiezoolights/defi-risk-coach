...
require("./tasks/Functions-consumer/deploy-guardian")
require("./tasks/Functions-consumer/deploy-risklock")
require("./tasks/Functions-consumer/deploy-proxy")
require("./tasks/Functions-consumer/deploy-risk-consumer")
require("./tasks/Functions-consumer/request")
require("./tasks/simulateScript.js")
